    ...
    return ReactDom.createPortal(
        <>
            ...
            <div className="bg-[#2d2934] w-[30vw] z-50 flex flex-col items-end h-[60vh] center rounded-lg shadow-xl">
                <button className="flex items-center justify-center rounded-r-md rounded-b-[0px] p-1 hover:bg-[#7c3036] w-[7%] h-[5vh] text-[#fff]" onClick={close}><Cross /></button>
                ...
                <form action="" onSubmit={handleSubmitContact} className="h-[45vh] flex flex-col w-full p-5 bg-[#342F39]">
                    ...
                    <input type="text" name="phone" className=" outline-none opacity-50 z-10 p-1 text-[#fff] placeholder:text-slate-500 rounded-lg mb-3 bg-[#53455f]"
                        required/>

                    <label htmlFor="name" className="pl-2 text-[#a7a5a5]">Name</label>
                    <input type="text" name="name" className="outline-none opacity-50 rounded-lg p-1 text-[#fff] placeholder:text-slate-500 mb-3 bg-[#53455f]"  
                        required/>
